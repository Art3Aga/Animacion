...
static void display(void)
{
	...
	glTexCoord2f(8.0f, 0.0f); glVertex3f( 10.0f, -10.0f, 1.0f);
	glTexCoord2f(8.0f, 8.0f); glVertex3f( 10.0f, 10.0f, 1.0f);
	glTexCoord2f(0.0f, 8.0f); glVertex3f(-10.0f, 10.0f, 1.0f);
	glEnd();
    glutSwapBuffers();
